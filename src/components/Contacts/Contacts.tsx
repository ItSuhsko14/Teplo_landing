  ...
  return (
    <>
      ...
      <div className={styles.cta}>
        Допоможіть нашій справі! {<br />}Навіть найменший донат або репост - це вже велика допомога. Зробіть репост, щоб
        більша кількість людей побачила наш збір, і ми мали можливість швидше надавати підтримку нашим військовим!
      </div>
    </>
  );
};
